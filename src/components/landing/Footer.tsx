      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-accent shadow-sm rounded-lg"
                />
              </div>
              <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-accent hover:bg-[#ff6400] active:bg-[#ff6400] active:shadow-none rounded-lg shadow">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
          {footerNavs.map((item, idx) => (
            <ul className="space-y-4 text-gray-300" key={idx}>
              <h4 className="text-accent font-semibold sm:pb-2">
                {item.label}
              </h4>
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          <p className="text-gray-300">
            © 2024 ChainGo | UchuvaLabs. All rights reserved.
          </p>
          <div className="flex items-center gap-x-6 text-gray-400 mt-6">
            ...
            <a
              href="https://github.com/UchuvaLabs/chaingo/tree/main"
              target="_blank"
            >
              <svg
                className="w-6 h-6 hover:text-accent duration-150"
